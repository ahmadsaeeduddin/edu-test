  ...
  return (
    <div className="bg-[#F7F7F5] py-20 border-t border-[#E0E0DC]">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        ...
        <Link href="/apply" className="px-8 py-3.5 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-md font-inter text-[15px] font-medium hover:from-amber-400 hover:to-orange-500 transition-all whitespace-nowrap">Get In Touch</Link>
      </div>
    </div>
  );
}
