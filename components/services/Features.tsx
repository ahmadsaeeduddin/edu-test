        ...
        <div className="flex flex-col gap-12">
          <div className="flex gap-8">
            ...
            <div className="max-w-[800px]">
              <h3 className="font-general text-[28px] text-[#111110] mb-3 tracking-[-0.2px]">Learn anywhere. Grow everywhere.</h3>
          ...
          <div className="flex gap-8">
            ...
            <div className="max-w-[800px]">
              <h3 className="font-general text-[28px] text-[#111110] mb-3 tracking-[-0.2px]">Cohort Bootcamps</h3>
          ...
          <div className="flex gap-8">
            ...
            <div className="max-w-[800px]">
              <h3 className="font-general text-[28px] text-[#111110] mb-3 tracking-[-0.2px]">Self-Paced Tracks</h3>
          ...
          <div className="flex gap-8">
            ...
            <div className="max-w-[800px]">
              <h3 className="font-general text-[28px] text-[#111110] mb-3 tracking-[-0.2px]">Focused Capsules</h3>
