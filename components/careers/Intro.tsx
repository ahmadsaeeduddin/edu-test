  ...
  return (
    <section className="py-24 bg-gray-50">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        <p className="text-xl md:text-3xl text-gray-700 leading-relaxed font-inter tracking-wide font-regular">
        ...
        <Link href="/apply" className="inline-flex items-center mt-12 text-separator hover:text-black transition group">
