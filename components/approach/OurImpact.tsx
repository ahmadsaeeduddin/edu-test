  ...
  return (
    <section className="py-24 bg-white border-t border-gray-100">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        <div className="mb-16">
          <h2 className="mb-4 font-general text-2xl font-medium tracking-tight text-slate-900 md:text-4xl">Our Impact</h2>
          <p className="mb-6 font-inter text-lg font-regular text-slate-800 md:text-xl">
