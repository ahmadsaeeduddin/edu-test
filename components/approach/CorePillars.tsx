      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        <div className="mb-20 grid grid-cols-1 gap-12 md:grid-cols-3">
          <div>
            ...
            <h3 className="mb-4 mt-2 font-general text-xl md:text-2xl font-medium">Research at the Core</h3>
            <p className="font-inter font-regular text-md md:text-lg leading-relaxed text-slate-600">
          ...
          <div>
            ...
            <h3 className="mb-4 mt-2 font-general text-xl md:text-2xl font-medium">AI as an Enabler</h3>
            <p className="font-inter font-regular text-md md:text-lg leading-relaxed text-slate-600">
          ...
          <div>
            ...
            <h3 className="mb-4 mt-2 font-general text-xl md:text-2xl font-medium">Industry-Relevant Learning</h3>
            <p className="font-inter font-regular text-md md:text-lg leading-relaxed text-slate-600">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          <div>
            ...
            <h3 className="mb-4 mt-2 font-general text-xl md:text-2xl font-medium">From Classroom to Impact</h3>
            <p className="font-inter font-regular text-md md:text-lg leading-relaxed text-slate-600">
          ...
          <div>
            ...
            <h3 className="mb-4 mt-2 font-general text-xl md:text-2xl font-medium">Skills for the Future</h3>
            <p className="font-inter font-regular text-md md:text-lg leading-relaxed text-slate-600">
